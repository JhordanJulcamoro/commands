...
echo "" > ~/.ssh/config.d/config.brocal.ug
...
$PSQL \
    ...
    id_eq=${Record[3]}
    orderid=${Record[4]}
    port_vnc=$((11200 + $orderid))
    FULL_NAME="EBUG_"$EQ_NAME"_"$id_eq
